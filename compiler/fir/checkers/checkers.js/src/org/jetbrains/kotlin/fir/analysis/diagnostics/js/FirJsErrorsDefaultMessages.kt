...
import org.jetbrains.kotlin.fir.analysis.diagnostics.js.FirJsErrors.NAMED_COMPANION_ON_EXPORTED_INTERFACE
...
object FirJsErrorsDefaultMessages : BaseDiagnosticRendererFactory() {
    override val MAP = KtDiagnosticFactoryToRendererMap("FIR").also { map ->
        ...
        map.put(NAMED_COMPANION_ON_EXPORTED_INTERFACE, "Named companions are not allowed inside exported interfaces.")
    }
}
