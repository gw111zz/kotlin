...
import org.jetbrains.kotlin.fir.analysis.diagnostics.web.common.FirWebCommonErrors.NAMED_COMPANION_ON_EXTERNAL_INTERFACE
...
object FirWebCommonErrorsDefaultMessages : BaseDiagnosticRendererFactory() {
    override val MAP = KtDiagnosticFactoryToRendererMap("FIR").also { map ->
        ...
        map.put(NAMED_COMPANION_ON_EXTERNAL_INTERFACE, "Named companions are not allowed inside external interfaces.")
    }
}