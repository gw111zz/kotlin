...
val test234 = <!CANNOT_INFER_PARAMETER_TYPE, NEW_INFERENCE_NO_INFORMATION_FOR_PARAMETER, NEW_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>C2<!>(<!CANNOT_INFER_PARAMETER_TYPE!>C2<!>(<!ARGUMENT_TYPE_MISMATCH!>if (true) 1 else null<!>))
