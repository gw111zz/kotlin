...
fun foo(a: A<String>, c: C<String>) {
    val x1 by <!EXPLICIT_TYPE_ARGUMENTS_IN_PROPERTY_ACCESS, PROPERTY_AS_OPERATOR, TYPE_ARGUMENTS_NOT_ALLOWED!>a<!>
    <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.String")!>x1<!>
    x1.length

    val y1 by <!EXPLICIT_TYPE_ARGUMENTS_IN_PROPERTY_ACCESS, PROPERTY_AS_OPERATOR, TYPE_ARGUMENTS_NOT_ALLOWED!>c<!>
