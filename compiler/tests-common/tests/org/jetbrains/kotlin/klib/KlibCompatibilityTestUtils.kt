...
object KlibCompatibilityTestUtils {
    interface TestConfiguration {
        ...
        fun buildKlib(
            ...
            klibFile: File,
            compilerVersion: KlibCompatibilityCompilerVersions,
        )
    ...
    fun runTest(testConfiguration: TestConfiguration, compilerVersionsSwitch: KlibCompatibilityCompilerVersionsScenario) =
        with(testConfiguration) {
            ...
            projectInfo.steps.forEach { projectStep ->
                projectStep.order.forEach { moduleName ->
                    ...
                    val version =
                        if (moduleName in projectInfo.compilerMutableLibraries) {
                            if (projectStep.id == 0) compilerVersionsSwitch.value1 else compilerVersionsSwitch.value2
                        } else KlibCompatibilityCompilerVersions.CURRENT
