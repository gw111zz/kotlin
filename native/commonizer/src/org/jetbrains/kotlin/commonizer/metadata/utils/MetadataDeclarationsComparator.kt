...
class MetadataDeclarationsComparator private constructor(private val config: Config) {
    ...
    sealed interface PathElement {
        ...
        class TypeFlexibleUpperBound(val upperBoundA: KmFlexibleTypeUpperBound, val upperBoundB: KmFlexibleTypeUpperBound) : PathElement {
        ...
        companion object {
            internal fun <E : Any> guess(entityA: E, entityB: E, entityKind: EntityKind, entityKey: String?): PathElement = when {
                ...
                entityA is KmFlexibleTypeUpperBound && entityB is KmFlexibleTypeUpperBound -> TypeFlexibleUpperBound(entityA, entityB)
